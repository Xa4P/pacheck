...
- df:
  ...
  a dataframe obtained through the \`calculate_ceac()\` or
  \`calculate_ceac_mult()\`.

- name_wtp:

  character. Name of variable of the dataframe containing the
  willingness-to-pay thresholds at which the probability of cost
