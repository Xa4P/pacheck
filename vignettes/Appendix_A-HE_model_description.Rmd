---
title: "PACBOARD: Probabilistic Analysis dashBOARD" 
subtitle: "Appendix A: Health Economic Model Description"
author: "Xavier G.L.V. Pouwels, Karel Kroeze, Naomi van der Linden, Michelle M.A. Kip, Hendrik Koffijberg"
...
# Model description  
The health economic (HE) model compares two strategies, called "intervention" and "comparator" for the treatment of mestatatic breast cancer. We used a yearly cycle and a time horizon of 30 years. We did not apply half cycle correction.  
...
The "intervention strategy" only reduces the transition probability from PFS to PD compared to the "comparator" strategy.  
...
| `r_d_costs` | Annual discount rate costs | 0.04 | - | Fixed |
  : Overview of the HE model input values  
