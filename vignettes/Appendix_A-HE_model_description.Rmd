...
# Model description  
The health economic (HE) model compares two strategies, called "intervention" and "comparator" for the treatment of mestatatic breast cancer. The We used a yearly cycle and a time horizon of 30 years. We did not apply half cycle correction.  
The "intervention" strategy incurs treatment costs and reduces the transition probability from PFS to PD compared to the "comparator" strategy. In addition, there is a change of experiencing adverse events in the intervention strategy which incurs additional costs and utility decrement once at the beginning of the HE model. The "comparator" strategy entails "doing nothing" and does not incur any treatment costs and adverse event-related utility decrement and costs.  
