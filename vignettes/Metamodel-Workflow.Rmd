...
ins_df = newdata #dataframe (define above)

```

Note that the order of the input vector matters. In the case of a three-variable model: the first, second, third, and fourth value represent the input for the first, second, third, and FIRST variable of the model, respectively 
...
# MAKING PREDICTIONS FOR LASSO DOES NOT WORK YET.............
