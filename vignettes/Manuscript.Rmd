...
The following section describes the case studies. Afterwards, the functionalities of `pacheck`, including anotated R code, are showcased on one open-source model (the other case studies are available in the Supplementary material). We continue by reflecting on facilitators to apply `pacheck` in these different case studies, and conclude by discussing limitations and areas of further development of `pacheck`.
